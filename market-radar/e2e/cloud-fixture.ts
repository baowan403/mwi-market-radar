...
function createSnapshot(timestamp: number, offset: number, latest: boolean, strategyQuotes = false): Snapshot {
  ...
  if (strategyQuotes) {
    Object.assign(quotes, {
      ...
      [marketKey('/items/bag_of_10_cowbells', 0)]: quote(1_000, 1_000, 1_000, 1_000),
      [marketKey('/items/shard_of_protection', 0)]: quote(10, 1_000, 10, 10),
      [marketKey('/items/mirror_of_protection', 0)]: quote(15, 1_000, 15, 15),
      [marketKey('/items/pearl', 0)]: quote(20, 1_000, 20, 20),
      [marketKey('/items/amber', 0)]: quote(30, 1_000, 30, 30),
      [marketKey('/items/garnet', 0)]: quote(40, 1_000, 40, 40),
      [marketKey('/items/jade', 0)]: quote(50, 1_000, 50, 50),
      [marketKey('/items/amethyst', 0)]: quote(60, 1_000, 60, 60),
      [marketKey('/items/moonstone', 0)]: quote(70, 1_000, 70, 70),
